...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-12-07 22:31`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d5a4090c-16dc-4f94-a3ab-6324e542ad2a.git
$ cd d5a4090c-16dc-4f94-a3ab-6324e542ad2a
```
